...
export const actions = {
    async createUser(_, data) {
        const res = await this.$axios.post('http://localhost/prueba_caypre_elton_back.php/auth-file/create-user.php', data);
    ...
    async loginUser({ commit }, data) {
        const res = await this.$axios.post('http://localhost/prueba_caypre_elton_back.php/auth-file/login-user.php', data);
        if (res.data.status == 1) {
            data.email = "";
            data.password = "";
    ...
    async readUser({ commit }) {
        ...
        const res = await this.$axios.get('http://localhost/prueba_caypre_elton_back.php/auth-file/read-user.php', config);
        if (res.data.status == 1) {
